      ...
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          <p className={`font-medium leading-snug line-clamp-2 ${
            isHighlighted ? "text-blue-300" : "text-gray-200 group-hover:text-white"
          }`}>
            {source.title}
          </p>
    ...
    <>
      ...
      {isOpen && (
        <div className="fixed inset-0 z-40 lg:hidden print:hidden">
          ...
          <div className="absolute left-0 right-0 bottom-0 max-h-[70vh] bg-gray-900 border-t border-gray-700 rounded-t-2xl overflow-hidden flex flex-col">
            {/* Handle bar */}
