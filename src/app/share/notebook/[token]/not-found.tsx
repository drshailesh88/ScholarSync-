...
export default function ShareNotebookNotFound() {
  return (
    <div className="min-h-screen bg-[#020617] flex items-center justify-center p-4">
      <div className="text-center">
        <h1 className="text-6xl font-bold text-[#f1f5f9] mb-4">404</h1>
        <p className="text-lg text-[#94a3b8] mb-2">Notebook not found</p>
        <p className="text-sm text-[#64748b] mb-8 max-w-md">
          This shared notebook link may have expired, been disabled by the
          owner, or the notebook may no longer exist.
        </p>
        <Link
          href="/"
