...
const coachSchema = z.object({
  ...
  audienceType: z.enum(["thesis_defense", "conference", "journal_club", "classroom", "general", "grant_presentation", "poster_session", "systematic_review", "patient_case", "grand_rounds", "lab_meeting", "departmental_seminar"]).optional(),
  slides: z
    .array(
      z.object({
...
export async function POST(req: Request) {
  ...
  try {
    ...
    const trace = traceGeneration({ tier: "standard", modelId: "claude-sonnet-4-20250514", feature: "presentation-coach", userId });
