 ...
 * Generated: 2026-03-16T11:33:53.211Z
 *
 * Each test case corresponds to one checkbox in the spec file.
 * The controller (qa/controller.ts) uses Playwright JSON output
 * and artifact existence to determine verdicts.
 *
 * DO NOT EDIT — regenerate with: npx tsx qa/spec-to-playwright.ts slides spec-021
 */
...
test.describe('slides / spec-021', () => {
  ...
  test('cp-006: Save status transitions idle saving saved idle auto-reset after 1500ms', async ({ page }) => {
    // Checkpoint 6: Save status transitions: `idle` → `saving` → `saved` → `idle` (auto-reset after 1500ms)
    // Section: Quick Test Workflows > Slide Store — Defaults & Internals
    ...
    const handled = await assertSlidesCheckpoint({
      page,
      description: "Save status transitions: `idle` → `saving` → `saved` → `idle` (auto-reset after 1500ms)",
      section: "Quick Test Workflows",
      subsection: "Slide Store — Defaults & Internals",
      rootDir: process.cwd(),
    });
    ...
    // This test validates: Save status transitions: `idle` → `saving` → `saved` → `idle` (auto-reset after 1500ms)
    // The controller will parse results from Playwright JSON output.
    // A PASS here means:
    //   1. Page loaded without crash
    //   2. Screenshot captured (proof of browser execution)
  ...
  test('cp-013: duplicateSlide appends copy to the source slides title', async ({ page }) => {
    ...
    // Section: Quick Test Workflows > Slide Store — Duplicate Slide Behavior
    ...
    const handled = await assertSlidesCheckpoint({
      ...
      section: "Quick Test Workflows",
      subsection: "Slide Store — Duplicate Slide Behavior",
      rootDir: process.cwd(),
    });
  ...
  test('cp-016: deleteSlide uses optimistic update removes from state before server call', async ({ page }) => {
    ...
    // Section: Quick Test Workflows > Slide Store — Delete Slide Behavior
    ...
    const handled = await assertSlidesCheckpoint({
      ...
      section: "Quick Test Workflows",
      subsection: "Slide Store — Delete Slide Behavior",
      rootDir: process.cwd(),
    });
  ...
  test('cp-020: addSlide creates a slide with layout title_content title New Slide one text bloc', async ({ page }) => {
    ...
    // Section: Quick Test Workflows > Slide Store — New Slide Defaults
    ...
    const handled = await assertSlidesCheckpoint({
      ...
      section: "Quick Test Workflows",
      subsection: "Slide Store — New Slide Defaults",
      rootDir: process.cwd(),
    });
  ...
  test('cp-022: setActiveSlide resets selectedBlockIndices to empty allBlocksSelected to false a', async ({ page }) => {
    ...
    // Section: Quick Test Workflows > Slide Store — Block Selection State
    ...
    const handled = await assertSlidesCheckpoint({
      ...
      section: "Quick Test Workflows",
      subsection: "Slide Store — Block Selection State",
      rootDir: process.cwd(),
    });
  ...
  test('cp-025: Tab cycling only works when selectedBlockIndicessize 0 AND allBlocksSelected is ', async ({ page }) => {
    ...
    // Section: Quick Test Workflows > Keyboard Shortcuts — Tab Cycling Guard
    ...
    const handled = await assertSlidesCheckpoint({
      ...
      section: "Quick Test Workflows",
      subsection: "Keyboard Shortcuts — Tab Cycling Guard",
      rootDir: process.cwd(),
    });
