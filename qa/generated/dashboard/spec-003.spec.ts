 ...
 * Generated: 2026-03-28T01:45:15.868Z
 *
 * Each test case corresponds to one checkbox in the spec file.
 * The controller (qa/controller.ts) uses Playwright JSON output
 * and artifact existence to determine verdicts.
 *
 * DO NOT EDIT — regenerate with: npx tsx qa/spec-to-playwright.ts dashboard spec-003
 */
...
test.describe('dashboard / spec-003', () => {
  ...
  test('cp-000: When no activity No activity yet Your research actions will appear here', async ({ page }) => {
    // Checkpoint 0: When no activity: "No activity yet. Your research actions will appear here."
    // Section: Recent Activity > Empty State
    ...
    const screenshotDir = path.join(process.cwd(), 'qa/artifacts/dashboard/spec-003');
  ...
  test('cp-001: ClockCounterClockwise icon on each row', async ({ page }) => {
    // Checkpoint 1: ClockCounterClockwise icon on each row
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-002: Action type displayed converted from snake_case to Title Case', async ({ page }) => {
    // Checkpoint 2: Action type displayed (converted from snake_case to Title Case)
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-003: Entity type displayed', async ({ page }) => {
    // Checkpoint 3: Entity type displayed
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-004: Creation time displayed relative format', async ({ page }) => {
    // Checkpoint 4: Creation time displayed (relative format)
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-005: Separator lines between rows', async ({ page }) => {
    // Checkpoint 5: Separator lines between rows
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-006: Hover background color changes', async ({ page }) => {
    // Checkpoint 6: Hover: background color changes
    // Section: Recent Activity > Activity Rows (max 8)
  ...
  test('cp-007: Sidebar visible on md breakpoint and above', async ({ page }) => {
    // Checkpoint 7: Sidebar visible on `md:` breakpoint and above
  ...
  test('cp-008: Sidebar hidden on mobile overlay mode', async ({ page }) => {
    // Checkpoint 8: Sidebar hidden on mobile (overlay mode)
    // Section: App Shell — Sidebar Navigation
  ...
  test('cp-009: Logo at top of sidebar', async ({ page }) => {
    // Checkpoint 9: Logo at top of sidebar
    // Section: App Shell — Sidebar Navigation
  ...
  test('cp-010: Active page has highlighted styling', async ({ page }) => {
    // Checkpoint 10: Active page has highlighted styling
    // Section: App Shell — Sidebar Navigation > Navigation Sections
  ...
  test('cp-011: User button Clerk at bottom of sidebar', async ({ page }) => {
    // Checkpoint 11: User button (Clerk) at bottom of sidebar
    // Section: App Shell — Sidebar Navigation > Navigation Sections
  ...
  test('cp-012: Mobile hamburger menu opens sidebar overlay', async ({ page }) => {
    // Checkpoint 12: Mobile: hamburger menu opens sidebar overlay
    // Section: App Shell — Sidebar Navigation > Navigation Sections
  ...
  test('cp-013: Mobile clicking outside overlay closes sidebar', async ({ page }) => {
    // Checkpoint 13: Mobile: clicking outside overlay closes sidebar
    // Section: App Shell — Sidebar Navigation > Navigation Sections
  ...
  test('cp-014: Dynamic greeting based on time of day', async ({ page }) => {
    // Checkpoint 14: Dynamic greeting based on time of day:
  ...
  test('cp-015: Good morning before noon', async ({ page }) => {
    // Checkpoint 15: "Good morning" (before noon)
    // Section: App Shell — Header
  ...
  test('cp-016: Good afternoon noon6pm', async ({ page }) => {
    // Checkpoint 16: "Good afternoon" (noon–6pm)
    // Section: App Shell — Header
  ...
  test('cp-017: Good evening after 6pm', async ({ page }) => {
    // Checkpoint 17: "Good evening" (after 6pm)
    // Section: App Shell — Header
  ...
  test('cp-018: Notification bell icon displayed placeholder', async ({ page }) => {
    // Checkpoint 18: Notification bell icon displayed (placeholder)
    // Section: App Shell — Header
  ...
  test('cp-019: Theme toggle button works light dark', async ({ page }) => {
    // Checkpoint 19: Theme toggle button works (light ↔ dark)
    // Section: App Shell — Header
  ...
  test('cp-020: Header spans full width above content area', async ({ page }) => {
    // Checkpoint 20: Header spans full width above content area
    // Section: App Shell — Header
  ...
  test('cp-021: Opens with CmdK Mac CtrlK WindowsLinux', async ({ page }) => {
    // Checkpoint 21: Opens with `Cmd+K` (Mac) / `Ctrl+K` (Windows/Linux)
  ...
  test('cp-022: Search input for filtering commands', async ({ page }) => {
    // Checkpoint 22: Search input for filtering commands
    // Section: Command Palette
  ...
  test('cp-023: Navigation commands available Dashboard Studio Literature Search Notebook Librar', async ({ page }) => {
    // Checkpoint 23: Navigation commands available: Dashboard, Studio, Literature Search, Notebook, Library, Archive, Compliance, Presentation, Settings
    // Section: Command Palette
  ...
  test('cp-024: Quick actions available Toggle theme New Project', async ({ page }) => {
    // Checkpoint 24: Quick actions available: Toggle theme, New Project
    // Section: Command Palette
  ...
  test('cp-025: Typing filters visible commands', async ({ page }) => {
    // Checkpoint 25: Typing filters visible commands
    // Section: Command Palette
  ...
  test('cp-026: Enter selects highlighted command', async ({ page }) => {
    // Checkpoint 26: Enter selects highlighted command
    // Section: Command Palette
  ...
  test('cp-027: Arrow keys navigate options', async ({ page }) => {
    // Checkpoint 27: Arrow keys navigate options
    // Section: Command Palette
  ...
  test('cp-028: Escape closes palette', async ({ page }) => {
    // Checkpoint 28: Escape closes palette
    // Section: Command Palette
  ...
  test('cp-029: Clicking outside closes palette', async ({ page }) => {
    // Checkpoint 29: Clicking outside closes palette
    // Section: Command Palette
  ...
  test('cp-030: Skeleton UI displays while server data loads', async ({ page }) => {
    // Checkpoint 30: Skeleton UI displays while server data loads
  ...
  test('cp-031: Skeleton for action cards section header', async ({ page }) => {
    // Checkpoint 31: Skeleton for action cards section header
    // Section: Loading State
  ...
  test('cp-032: 4 skeleton cards in grid matching action cards layout', async ({ page }) => {
    // Checkpoint 32: 4 skeleton cards in grid (matching action cards layout)
    // Section: Loading State
  ...
  test('cp-033: Skeleton for projects section header', async ({ page }) => {
    // Checkpoint 33: Skeleton for projects section header
    // Section: Loading State
  ...
  test('cp-034: SkeletonTable with 4 rows icon content badge placeholders', async ({ page }) => {
    // Checkpoint 34: SkeletonTable with 4 rows (icon, content, badge placeholders)
    // Section: Loading State
