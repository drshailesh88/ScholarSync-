...
- [ ] FAIL: **Breadcrumb display** — below title, shows domain > path breadcrumb in brand color `[CODE]`
...
- [ ] FAIL: **"Saved to Library" toast** — after saving, success toast appears at bottom `[CODE]`
- [ ] FAIL: **"Already in Library" toast** — save a result that's already saved, verify info toast `[CODE]`
...
- [ ] FAIL: **Domain preference control** — expand "Domain Preference" section, verify 5 levels: Prefer/Higher/Neutral/Lower/Mute `[CODE]`
- [ ] FAIL: **Set domain preference** — click a preference level, verify it highlights as selected `[CODE]`
