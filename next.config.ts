...
// CSP: 'unsafe-inline' and 'unsafe-eval' are currently required for third-party scripts
// (Clerk, Razorpay, PostHog). These should be replaced with nonces in a future iteration.
const csp = [
  "default-src 'self'",
