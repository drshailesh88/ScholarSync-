...
### Action Cards
- [ ] FAIL: Section title "What do you want to do today?" displayed
...
- [ ] FAIL: Title: "Literature Search"
- [ ] FAIL: Description: "Query 200M+ academic papers. Extract consensus."
- [ ] FAIL: Click navigates to `/research`
...
- [ ] FAIL: Title: "Write & Draft"
- [ ] FAIL: Description: "Open the luminous studio. Start writing with focus."
- [ ] FAIL: Click navigates to `/studio`
...
- [ ] FAIL: Title: "Learn Mode"
- [ ] FAIL: Description: "Socratic AI tutor. Think critically, learn deeply."
- [ ] FAIL: Click navigates to `/studio?mode=learn`
...
- [ ] FAIL: Title: "Final Checks"
- [ ] FAIL: Description: "Run plagiarism and AI-detection compliance audits."
- [ ] FAIL: Click navigates to `/compliance`
...
- [ ] FAIL: Cursor pointer on hover
- [ ] FAIL: All four cards render at equal height

### Stats Overview
- [ ] FAIL: Section title "Your Research at a Glance" displayed
