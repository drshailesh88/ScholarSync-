...
- [ ] FAIL: Edit button stores SVG under `sessionStorage['scholarsync-illustration-agent-import']` when no override callback is provided
- [ ] FAIL: Edit button redirects to `/illustrate/editor?import=agent`
...
- [ ] FAIL: Preview-pane close button title is "Close preview"
