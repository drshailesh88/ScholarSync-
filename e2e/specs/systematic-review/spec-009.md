...
### Snowballing Panel
#### Configuration
- [ ] FAIL: **Depth 2** — citations of citations
#### Execution
- [x] PASS: **Run snowballing** — triggers citation search
- [x] PASS: **API call** — `POST /api/systematic-review/snowball`
- [ ] FAIL: **Progress indicator** — shows progress during search
- [ ] FAIL: **Results list** — newly discovered papers displayed
#### Session History
- [x] PASS: **Session tracking** — previous snowballing runs saved
- [ ] FAIL: **Session list** — past sessions viewable with date and results
- [ ] FAIL: **Session details** — expand to see papers found in each session
#### Citation Network Visualization
- [ ] FAIL: **Network graph** — visual network of citation relationships
- [ ] FAIL: **Node interaction** — click nodes to view paper details
- [ ] FAIL: **Edge display** — citation direction shown on edges
- [ ] FAIL: **Included papers highlighted** — distinguish between included and new papers
#### API
...
- [ ] FAIL: **File validation** — invalid files show error message
- [x] PASS: **Parse preview** — shows count of papers found before confirming import
- [ ] FAIL: **Duplicate handling** — detects and flags duplicates against existing papers
#### Export
...
- [ ] FAIL: **Guidance text** — each section shows guidance on what to include
- [ ] FAIL: **Rich text editing** — formatting supported within sections
