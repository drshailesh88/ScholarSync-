...
- [ ] FAIL: Copy feedback text: "Copied!" for exactly 2000ms
...
- [ ] FAIL: Category dropdown default: "All Categories"
...
- [ ] FAIL: AbortError caught and silently ignored (DOMException with name "AbortError")
- [ ] FAIL: Browse mode empty state: "No journals found matching your filters."
- [ ] FAIL: Browse mode subtitle: "Explore the curated directory by category, specialty, or publisher."
- [ ] FAIL: "Can't find what you're looking for?" help section only in search mode
- [ ] FAIL: "Can't find" text varies: references PubMed + RSS URL when no feeds found vs when some found
- [x] PASS: Journal card category pill: `rounded-full bg-surface-raised px-2 py-0.5 text-[10px] text-ink-muted`
- [ ] FAIL: Journal card specialty pill: same styling as category pill
