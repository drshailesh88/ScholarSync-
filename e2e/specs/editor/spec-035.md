...
#### Command Palette
- [x] PASS: Global command palette input placeholder is `Type a command or search...`
- [x] PASS: Global command palette closes on backdrop click
- [x] PASS: Global command palette closes on `Escape`
- [x] PASS: Global command palette navigation commands include `Dashboard`, `Studio`, `Literature Search`, `Notebook`, `Library`, `Archive`, `Compliance`, `Presentation`, and `Settings`
