...
| 4 | GAP-003 | LaTeX | Paper creation crashes before workspace opens | D3=1, D4=1, D7=1 | 14/35 | 24+ | M | P0 | DONE (1->4, 4a1029f) |
| 5 | GAP-004 | Integrity | Pasted-text check never reaches results | D1=1, D3=1, D4=1 | 13/35 | 24+ | M | P0 | DONE (1->3, 4a1029f+hardening) |
| 6 | GAP-006 | Systematic Review | Empty-state project creation blocked | D4=1, D7=1 | 16/35 | 24+ | M | P2 | DONE (1->4, 4a1029f) |
| 7 | GAP-005 | Notebook | Cross-source answer does not render reliably | D1=2, D3=2, D4=2 | 22/35 | 27+ | M | P2 | DONE (2->3, 4a1029f) |
